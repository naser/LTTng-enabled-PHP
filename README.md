...
Currently it only supports PHP 7.x, and  LTTng >= 2.8 and the support for the other php versions will be added shortly. to install LTTng 2.9 in Ubuntu you can use these commands:
